                    ...
                    <li>                                
                        <a href="javascript:void(0)" class="button-togole togole-loginform" data-togole="piko-show-account">                                
                            <?php if(is_user_logged_in()): ?>
                                    <span class="icon icon-lock2" aria-hidden="true"> <i><?php echo $GLOBALS['current_user']->display_name ?></i></span>
                                    <?php else: ?>
                                    <span class="icon icon-lock2" aria-hidden="true"> <i><?php echo esc_html__('Login', 'xtocky'); ?></i></span>
                            <?php endif;?>
                            <?php if(is_user_logged_in()): ?>
                                    <span class="icon icon-lock" aria-hidden="true"> <i><?php echo $GLOBALS['current_user']->display_name ?></i></span>
                                    <?php else: ?>
...
if ( !function_exists( 'xtocky_get_header_toggle' ) ){ //since v1.0.5
    function xtocky_get_header_toggle(){
        ...
        <div class="navbar-toggle">
            ...
            <?php if($menu_style != '4' && $show_search == 1): ?>
    ...
    function xtocky_get_header_right(){
        ...
        <div class="dropdowns-container">                        
                        ...
                        <div class="dropdowns-wrapper">  
                            <?php  if(($menu_style != '4') && $show_search == '1'){ echo '<div class="dropdown header-dropdown search-full hidden-xs hidden-sm"><a class="piko-modal-open" href="javascript:void(0);"><i class="fa fa-search"></i></a></div>'; } ?>
                                                       
                            <?php   xtocky_header_login_form(); ?>                           
                            <?php   xtocky_get_header_cart();?>
                            <?php 
                            $main_menu_wpml = xtocky_get_option_data('menu_bar_right_wpml', '0');
                            if($main_menu_wpml == 0 && $show_cart == 1 && $menu_style != '2' || $main_menu_wpml == 0 && $show_cart == 1 && $menu_style != '6'):?>
                ...
                <a href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     <?php if(is_user_logged_in()): ?>
                            <span><i class="icon-header icon-lock2" aria-hidden="true"></i></span>
                             <span class="dropdown-text"> <?php echo $GLOBALS['current_user']->display_name ?></span>
                            <?php else: ?>
...
function xtocky_payment_logo(){
    ...
    if ($payment_logo_upload != '') : ?>
        <div class="payments-icon">
                ...
                ?>                                           
                <img src="<?php echo wp_get_attachment_url( $payment_photo_id ); ?>" alt=""/>                                      
                <?php endforeach; ?>
        </div><!-- .payments-icon-->         
    <?php
    endif;
