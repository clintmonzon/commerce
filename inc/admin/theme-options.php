<?php
    ...
    $args = array(
        'opt_name'             => $opt_name,
        'display_name'         => 'Xtocky ' . esc_html__('Options', 'xtocky') . '<a class="admin-theme-link" href="' . admin_url( 'admin.php?page=pikoworks' ) . '">Welcome</a><a class="admin-theme-link" href="' . admin_url( 'admin.php?page=pikoworks-system' ) . '">System Status</a><a class="admin-theme-link" href="' . admin_url( 'admin.php?page=pikoworks-plugins' ) . '">Plugins</a><a class="admin-theme-link admin-theme-link-last" href="' . admin_url( 'admin.php?page=pikoworks-support' ) . '">Support</a>',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'desc'     => esc_html__( 'The logo size default width: 180px, height: 27px', 'xtocky' ),
                'compiler' => true,
                'default'  => array(
            ...
            array(
                ...
                'desc'     => esc_html__( 'Sticky logo should be samller to main logo The logo size default width: 180px, height: 80px.', 'xtocky' ),
                'compiler' => true,
                'default'  => array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                    ...
                    'type'    => 'switch',
                    'title'   => esc_html__( 'WPML Currency Switcher', 'xtocky' ),
                    'default' => '0',
                    'on' => esc_html__( 'Enable', 'xtocky' ),
                    'off' => esc_html__( 'Disabled', 'xtocky' ),
                    'required' => array( 'menu_top_bar_wpml_area', '=', array('left', 'right')),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array (
                    ...
                    'transparent' => false,
                    'output'    => array(
                        'color' => '.category-menu .secondary-menu-wrapper .secondary-title,.category-menu .secondary-menu-wrapper .secondary-title:after,.header-layout-3 .mobile-main-menu li.menu-item a, .header-layout-3 .mobile-main-menu li.menu-item h5,.header-layout-3 .mobile-main-menu span.arrow,.header-layout-3 .menu-widgets .widget-title, .header-layout-3 .menu-widgets .social-icons a, .mega-menu > li.menu-item > a, body:not(.header-layout-4):not(.header-layout-5) .cart-dropdown a > i, .header-dropdown > li > a > i, .header-layout-6 .header-dropdown.login-dropdown > a > span:not(.dropdown-text), .header-layout-1 .header-dropdown.login-dropdown > a > span:not(.dropdown-text), .header-search-container > a > i, .header-layout-4 .mega-menu > li.menu-item > a,.header-layout-2 .header-dropdown > a,.header-layout-2 .search-form .overlay-search,.header-layout-3 .cart-dropdown a > i, .header-layout-3 .header-search-container > a > i, .header-layout-3 .mega-menu > li.menu-item > a,.header-layout-3 .header-dropdown.login-dropdown > a > span:not(.dropdown-text),.navbar-toggle button span:not(.icon-line3)'),                    
            ),            
            array (
            ...
            array (
                    ...
                    'default' => '',
                    'transparent' => false,
                    'output'    => array('background-color' => '.header-search-container .btn,.header-dropdown.cart-dropdown > a .badge-number')
            ),
            array (
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'    => 'switch',
                'title'   => esc_html__( 'Enable footer inner top widgets area.', 'xtocky' ),                 
                'default' => 0,
                'on' => esc_html__( 'Enable', 'xtocky' ),
                'off' => esc_html__( 'Disabled', 'xtocky' ),
            ),
            ...
            array(
                'id'      => 'footer_widgets',
                'type'    => 'switch',
                'title'   => esc_html__( 'Enable footer inner widgets area.', 'xtocky' ),                 
                'default' => 1,
                'on' => esc_html__( 'Enable', 'xtocky' ),
                'off' => esc_html__( 'Disabled', 'xtocky' ),
            ),
...
//                'required' => array( 'footer_layout', '=', 'layout3' ),
    ...
    //Blog setup   
    Redux::setSection( $opt_name, array(
        'title' => esc_html__( 'Archive Blog Setting', 'xtocky' ),
     ...
     Redux::setSection( $opt_name, array(
        'title' => esc_html__( 'Blog Single Page', 'xtocky' ),
        'subsection' => true,
        'fields'     => array(                      
            array(
   ...
   * Check if WooCommerce is active
    **/
    ...
    Redux::setSection( $opt_name, array(
        ...
        Redux::setSection( $opt_name, array(
        'title' => esc_html__( 'Archive Product', 'xtocky' ),
        'subsection' => true,    
        'fields'     => array(
            array(
    ...
    Redux::setSection( $opt_name, array(
        'title' => esc_html__( 'Single Product', 'xtocky' ),
        'subsection' => true,
        'fields'     => array(            
            array(
            ...
            array (
                    ...
                    'subtitle' => esc_html__('Enable / Disable Related Products.', 'xtocky'),
                    'id' => 'related_products',
                    'on' => esc_html__('Enabled', 'xtocky'),
                    'off' => esc_html__('Disabled', 'xtocky'),
                    'type' => 'switch',
            ...
            array (
                    ...
                    'subtitle' => esc_html__('Enable / Disable Upsell Products.', 'xtocky'),
                    'id' => 'upsell_products',
                    'on' => esc_html__('Enabled', 'xtocky'),
                    'off' => esc_html__('Disabled', 'xtocky'),
                    'type' => 'switch',
            ...
            array (
                    'title' => esc_html__('Review Tab', 'xtocky'),
                    'subtitle' => esc_html__('Enable / Disable Review Tab.', 'xtocky'),
                    'id' => 'review_tab',
                    'on' => esc_html__('Enabled', 'xtocky'),
                    'off' => esc_html__('Disabled', 'xtocky'),
                    'type' => 'switch',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            array(
                'id'         => 'dummy-content',
                'type'       => 'dummy_content',
                'title'      => esc_html__( 'Install Dummy content', 'xtocky' ),                
            ),
        )
    ));
    Redux::setSection( $opt_name, array(
