...
<?php endif; ?>
		...
		<form method="post" class="woocommerce-form woocommerce-form-login login">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group label-overlay">
				<label for="username"><span class="icon-user"></span><?php esc_html_e( 'Username or email address', 'woocommerce' ); ?> <span class="required">*</span></label>
				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" value="<?php if ( ! empty( $_POST['username'] ) ) echo esc_attr( $_POST['username'] ); ?>" />
			</p>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group label-overlay">
				<label for="password"><span class="icon-lock"></span><?php esc_html_e( 'Password', 'woocommerce' ); ?> <span class="required">*</span></label>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2 col-md-6">
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group label-overlay">
				<label for="reg_email"><span class="icon-envalop"></span><?php _e( 'Email address', 'woocommerce' ); ?> <span class="required">*</span></label>
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group label-overlay">
					<label for="reg_password"><span class="icon-lock2"></span><?php _e( 'Password', 'woocommerce' ); ?> <span class="required">*</span></label>
