...
if( is_archive() || is_product_taxonomy() || is_product_tag() ): ?>
    <div class="products product-container-row row products-container max-col-<?php echo esc_attr($products_per_row);?> <?php echo esc_attr($class)?>" data-layoutmode="fitRows">
<?php
else: ?>
