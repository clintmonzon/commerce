...
if (!function_exists('xtocky_inc_library')) {
    function xtocky_inc_library(){
        ...
        require_once(XTOCKY_INC_DIR . 'admin/plugin-activation/class-tgm-plugin-activation.php');
        require_once(XTOCKY_INC_DIR . 'admin/plugin-activation/plugin-init.php');
        ...
        if(function_exists( 'WC' )){
            ...
            require_once(XTOCKY_INC_DIR . 'woocommerce/openswatch/init.php');
