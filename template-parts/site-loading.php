...
?>
<div id="site-loading" <?php echo balanceTags($custom_bg_color);?> class="<?php echo esc_attr($home_preloader); ?>">
    <div class="loading-center">
        <div class="site-loading-center-absolute">            
            <?php if ($home_preloader == 'round-1') : ?>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner" id="spinner_one"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner" id="spinner_two"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner" id="spinner_three"></div>
            <?php endif; ?>           
            <?php if ($home_preloader == 'various-4') : ?>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner"></div>
            ...
            <?php if ($home_preloader == 'various-7') : ?>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner" id="spinner_four"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner" id="spinner_three"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner" id="spinner_two"></div>
                <div <?php echo balanceTags($custom_spinner_color);?> class="spinner" id="spinner_one"></div>
            <?php endif; ?>
