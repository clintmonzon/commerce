...
<form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="header-search-form-full <?php echo esc_attr($class); ?>">
    <div class="wrap">    
       <input type="text" id="<?php echo $unique_id; ?>" placeholder="<?php esc_attr_e( 'Type here...', 'xtocky' ); ?>" value="<?php echo get_search_query(); ?>" autocomplete="off" class="form-control" name="s"/>
